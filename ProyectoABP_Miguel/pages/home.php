    ...
    <div id="carouselExampleControls" class="carousel slide" data-ride="carousel">
        <div class="carousel-inner">
            <div class="carousel-item active">
                <img class="d-block w-100 h-100" src="/ProyectoABP/imagenes/img1.jpg">
            </div>
            <div class="carousel-item">
                <img class="d-block w-100 h-100" src="/ProyectoABP/imagenes/img2.jpeg">
            </div>
            <div class="carousel-item">
                <img class="d-block w-100 h-100" src="/ProyectoABP/imagenes/img3.jpg">
            </div>
            <div class="carousel-item">
                <img class="d-block w-100 h-100" src="/ProyectoABP/imagenes/img4.jpg">
            </div>
        </div>
