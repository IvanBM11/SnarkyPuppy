            ...
            <div class="collapse" id="navbarToggleExternalContent">
                <div class="p-2" id="desplegable">
                    <ul class="navbar-nav">
                        ...
                        <li class="nav-item menu"><a href="/ProyectoABP/pages/who.php" style="color:white" class="nav-link">WHO ARE WE</a></li>                       <li class="nav-item menu"><a href="/ProyectoABP/pages/totenigmas.php" style="color:white" class="nav-link">PUZZLES</a></li>
                    </ul>
                </div>
            </div>
